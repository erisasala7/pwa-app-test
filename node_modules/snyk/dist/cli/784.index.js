...
Object.defineProperty(exports, "initalUserMessageOutput", ({ enumerable: true, get: function () { return v2_1.initalUserMessageOutput; } }));
Object.defineProperty(exports, "shouldPrintIacInitialMessage", ({ enumerable: true, get: function () { return v2_1.shouldPrintIacInitialMessage; } }));
...
exports.colors = {
    severities: {
        critical: chalk_1.default.hex('#AB191A'),
        high: chalk_1.default.hex('#CE501A'),
        medium: chalk_1.default.hex('#D68000'),
        low: chalk_1.default.hex('#88879E'),
    },
    failure: chalk_1.default.hex('#B81415'),
    success: chalk_1.default.hex('#00BB00'),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.formatIacTestFailures = void 0;
...
function formatIacTestFailures(testFailures) {
    ...
    const titleOutput = color_utils_1.colors.info.bold(`Invalid Files: ${testFailures.length}`);
...
function formatFailure(failureReason, testFailures) {
    ...
    return (color_utils_1.colors.failure.bold(failureReason) +
        os_1.EOL +
        pathPrefix +
        testFailures
...
var initial_user_message_1 = __webpack_require__(33231);
Object.defineProperty(exports, "initalUserMessageOutput", ({ enumerable: true, get: function () { return initial_user_message_1.initalUserMessageOutput; } }));
Object.defineProperty(exports, "shouldPrintIacInitialMessage", ({ enumerable: true, get: function () { return initial_user_message_1.shouldPrintIacInitialMessage; } }));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.shouldPrintIacInitialMessage = exports.initalUserMessageOutput = void 0;
const color_utils_1 = __webpack_require__(4960);
exports.initalUserMessageOutput = color_utils_1.colors.info.bold('Snyk testing Infrastructure as Code configuration issues...');
...
exports.shouldPrintIacInitialMessage = shouldPrintIacInitialMessage;
...
function formatShareResultsOutput(outputMeta) {
    return color_utils_1.colors.info.bold(v1_1.shareResultsOutput(outputMeta));
}
...
function formatIacTestSummary(testData, outputMeta) {
    const title = color_utils_1.colors.info.bold('Test Summary');
...
function formatCountsSection(testData) {
    ...
    countsSectionProperties.push(`${color_utils_1.colors.success.bold(theme_1.icon.VALID)} Files without issues: ${color_utils_1.colors.info.bold(`${filesWithoutIssues}`)}`);
    countsSectionProperties.push(`${color_utils_1.colors.failure.bold(theme_1.icon.ISSUE)} Files with issues: ${color_utils_1.colors.info.bold(`${filesWithIssues}`)}`);
    countsSectionProperties.push(`${INDENT}Ignored issues: ${color_utils_1.colors.info.bold(`${testData.ignoreCount}`)}`);
    ...
    countsSectionProperties.push(`${INDENT}Total issues: ${color_utils_1.colors.info.bold(`${totalIssuesCount}`)} [ ${color_utils_1.colors.severities.critical(`${issueCountsBySeverities.critical} critical`)}, ${color_utils_1.colors.severities.high(`${issueCountsBySeverities.high} high`)}, ${color_utils_1.colors.severities.medium(`${issueCountsBySeverities.medium} medium`)}, ${color_utils_1.colors.severities.low(`${issueCountsBySeverities.low} low`)} ]`);
